...
public class M_OrderOutlet {

    private int _id,_outletId,_outletCode,_routeId,_orderStatus;
    private String _outletName;
    private String _orderCS;

    public M_OrderOutlet(){

    }

    public M_OrderOutlet(int id,int outletId, int outletCode,  String outletName,int routeId, String orderCS,int orderStatus ) {
        this._id = id;
    ...
    public M_OrderOutlet(int outletId, int outletCode,  String outletName,int routeId, String orderCS,int orderStatus ) {
